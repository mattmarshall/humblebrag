...
export default function Home() {
  return <main className="siteShell">
    <header className="siteNav"><a className="brand" href="/"><span className="brandGlyph">h</span> humblebrag</a><span className="navAside">synthetic social achievement theater</span></header>
