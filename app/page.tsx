...
import { findHomepagePost, hydratePost } from "../lib/posts";

export const dynamic = "force-dynamic";

export default async function Home() {
  const record = await findHomepagePost();
  const initialPost = record ? hydratePost(record) : undefined;
  return <main className="siteShell">
    ...
    <Generator initialPost={initialPost} initialNetwork={initialPost?.network} />
  </main>;
}
